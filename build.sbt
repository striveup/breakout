...
val projectName = "smallBreak"
val projectVersion = "1.2.1"

val projectMainClass = "com.neo.sk.smallBreak.Boot"
...
lazy val backend = (project in file("backend")).enablePlugins(PackPlugin)
  ...
  .settings(
    ...
    packMain := Map("smallBreak" -> projectMainClass),
    packJvmOpts := Map("smallBreak" -> Seq("-Xmx64m", "-Xms32m")),
    packExtraClasspath := Map("smallBreak" -> Seq("."))
  )
  .settings(
